...
class CustomerControllerTest {
    ...
    void testListCustomersByName() {
        ...
        webTestClient.get()
            .uri(uriBuilder -> uriBuilder.path(CustomerController.CUSTOMER_PATH)
    ...
    void testListCustomersEmptyName() {
        webTestClient.get()
            .uri(uriBuilder -> uriBuilder.path(CustomerController.CUSTOMER_PATH).queryParam("customerName", "").build())
            .exchange()
            .expectStatus()
            .isBadRequest();
    }
    ...
    void testListCustomersByNameEmpty() {
        webTestClient.get()
            .uri(CustomerController.CUSTOMER_PATH + "?customerName=")
            .exchange()
            .expectStatus()
            .isBadRequest();
    }
